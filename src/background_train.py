...
SEQUENTIAL_VALID_DATASET = HaiconDataset(VALID_DF_RAW[TIMESTAMP_FIELD],
                                         VALID_DF[SEQUENTIAL_COLUMNS],
                                         attacks=VALID_DF_RAW[ATTACK_FIELD])
CATEGORICAL_VALID_DATASET = HaiconDataset(VALID_DF_RAW[TIMESTAMP_FIELD],
                                          VALID_DF[CATEGORICAL_COLUMNS],
                                          attacks=VALID_DF_RAW[ATTACK_FIELD])
